...
//  SLToolbox
//
//  Created by Lukasz Szarkowicz on 26/06/2019.
...
public extension AssociatedObjectAccessible {
    ...
    func getAssociatedObject<T>(for key: UnsafeRawPointer, defaultValue: T, defaultValuePolicy: AssociatedObjectAccessiblePolicy? = nil) -> T {
    ...
    func setAssociatedObject<T>(for key: UnsafeRawPointer, value: T?, policy: AssociatedObjectAccessiblePolicy = .strong) {
